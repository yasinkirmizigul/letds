...
## Corpus Check
- 655 files · ~253,871 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3875 nodes · 8413 edges · 432 communities (284 shown, 148 thin omitted)
...
## Communities (432 total, 148 thin omitted)
...
### Community 23 - "Member"
Cohesion: 0.13
Nodes (3): Member, Builder, Authenticatable
...
Cohesion: 0.10
Nodes (7): HomeController, View, BelongsTo, Builder, HasMany, SitePage, Request
...
Cohesion: 0.08
Nodes (11): AuthController, Request, Request, ProfileController, MemberAuthController, RedirectResponse, Request, View (+3 more)
...
### Community 65 - "Media"
Cohesion: 0.05
Nodes (41): MediaController, JsonResponse, Request, Media, HasMany, MediaService, UploadedFile, LocalizedContentTranslationService (+33 more)
...
Cohesion: 0.09
Nodes (8): JsonResponse, Request, ProductGalleryController, Builder, HasMany, MorphToMany, Product, BelongsToMany
...
Cohesion: 0.09
Nodes (8): Galleryable, AppointmentSlot, BelongsTo, HasFactory, HasSiteLocaleTranslations, Model, Notifiable, SoftDeletes
...
Cohesion: 0.06
Nodes (11): BaseTestCase, RefreshDatabase, AdminDashboardLayoutTest, AdminLoginBrandingTest, AdminMenuVisibilityAccessTest, HomepageConfigurationTest, MediaServiceWebpTest, TestCase (+3 more)
...
Cohesion: 0.20
Nodes (5): EcommerceOrderStatusHistory, BelongsTo, HasMany, SiteHomepageConfig, AdminDemoDataFactoryTest
...
Cohesion: 0.28
Nodes (4): HomeSliderTranslation, BelongsTo, BelongsTo, SiteSettingTranslation
...
Cohesion: 0.09
Nodes (17): BlogPostGalleryController, JsonResponse, Request, JsonResponse, Request, TinyMceController, Controller, PageController (+9 more)
...
- **Why does `Controller` connect `reset-password.blade.php` to `AppointmentSettingsController`, `BlogPost`, `UserController`, `CategoryController`, `0001_01_01_000002_create_jobs_table.php`, `SiteTranslationSyncService`, `HomepageConfigurationService`, `PaymentIntegration`, `.index`, `Role`, `User`, `Product`, `Category`, `SiteSetting`, `SiteLanguage`, `member-forgot-password.blade.php`, `Illuminate\Console\Command`, `Illuminate\Http\JsonResponse`, `AuditEvent`, `AdminMenuRegistry`, `ModuleGenerator`, `ContentPageController`, `EcommerceInvoice`, `SitePage.php`, `Illuminate\Http\RedirectResponse`, `AppointmentCalendarController`, `Illuminate\Http\Request`, `require-dev`, `SiteFaq`, `manage.js`, `CategoryTree`, `Illuminate\Database\Eloquent\Builder`, `Media`, `AdminQuickSearchController`, `AdminNotification`, `EcommerceCoupon`, `Illuminate\Foundation\Http\FormRequest`, `static`, `Illuminate\Database\Eloquent\Model`, `StoreContactMessageRequest`, `config`, `ProjectFile`, `AppointmentController`, `psr-4`, ``appointments``, `post-create-project-cmd`, `blog/index.js`, `password-confirmation.js`, `autoload-dev`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `HomepageConfigurationTest`, `GalleryController.php`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `Media` connect `Media` to `AppointmentSettingsController`, `BlogPost`, `SitePortalFlowTest`, `CategoryController`, `Controller`, `EcommerceCoupon`, `Illuminate\Database\Eloquent\Model`, `.index`, `config`, `Project`, `Permission`, `.now`, `create-form-accordion.js`, `Product`, `require-dev`, `member-forgot-password.blade.php`, `manage.js`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `AppointmentSettingsController`, `SiteTranslationSyncService`, `.index`, `Role`, `SiteNavigationItem`, `.now`, `reset-password.blade.php`, `Member`, `SiteSetting`, `ajax-forms.js`, `ContactMessage`, `AdminMenuRegistry`, `Illuminate\Bus\Queueable`, `ServiceReviewFlowTest`, `AppointmentCalendarController`, `require-dev`, `Illuminate\Database\Eloquent\Builder`, `ProfileController`, `AdminQuickSearchController`, `AdminNotification`, `Illuminate\Database\Eloquent\Model`, `Permission`, `create-form-accordion.js`, `UpdateCategoryRequest`, ``appointments``, `HomepageConfigurationTest`, `SitePortalFlowTest`, `ServiceReviewItem`?**
