# Graph Report - letds  (2026-08-01)

## Corpus Check
- 557 files · ~209,381 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3060 nodes · 6873 edges · 374 communities (233 shown, 141 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 467 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e000656c`
...
- 2026_04_23_000004_create_admin_dashboard_preferences_table.php
...
- 2025_12_26_130317_create_audit_logs_table.php
...
Cohesion: 0.05
Nodes (17): InvoiceController, PaymentWebhookEventController, MemberController, AdminMenuVisibilityController, ContactMessageController, HomepageConfigurationController, Controller, MemberAuthController (+9 more)

### Community 1 - "BlogPost"
Cohesion: 0.09
Nodes (5): BlogPostController, BlogPost, media(), mediaIn(), Illuminate\Database\Eloquent\Relations\MorphToMany
...
Cohesion: 0.09
Nodes (9): BlogPostGalleryController, GalleryController, GalleryItemsController, ProductGalleryController, ProjectGalleryController, TinyMceController, Gallery, AuditEvent (+1 more)

### Community 6 - "Role"
Cohesion: 0.15
Nodes (4): RoleController, UserController, Role, Rbac

### Community 7 - "Project"
Cohesion: 0.08
Nodes (4): ProjectController, ProjectPublicController, ProjectUpdateRequest, Project

### Community 8 - "ModuleNamer"
Cohesion: 0.06
Nodes (11): AdminModuleInstallCommand, MakeAdminModule, SyncServiceReviews, TrashPurgeCommand, AdminModuleInstaller, FilePatcher, ModuleGenerator, ModuleNamer (+3 more)

### Community 9 - "Illuminate\Database\Eloquent\Relations\BelongsTo"
Cohesion: 0.08
Nodes (8): AdminDashboardPreference, EcommerceOrderItem, EcommerceOrderStatusHistory, InventoryMovement, PaymentWebhookEvent, GalleryItem, AppointmentSlot, Illuminate\Database\Eloquent\Relations\BelongsTo
...
Cohesion: 0.04
Nodes (44): alpinejs, axios, blade-formatter, @fontsource-variable/besley, @fontsource-variable/schibsted-grotesk, @fullcalendar/core, @fullcalendar/daygrid, @fullcalendar/interaction (+36 more)

### Community 12 - "Member"
Cohesion: 0.06
Nodes (5): Member, MediaService, Illuminate\Foundation\Auth\User, Illuminate\Http\UploadedFile, Intervention\Image\ImageManager

### Community 13 - "Illuminate\Database\Eloquent\Model"
Cohesion: 0.09
Nodes (10): BlogPostTranslation, CategoryTranslation, EcommerceInvoice, Galleryable, MediaTranslation, ProductTranslation, ProjectTranslation, localizedValue() (+2 more)
...
Cohesion: 0.17
Nodes (4): AdminMenuSetting, AdminMenuRegistry, AdminMenuVisibility, Illuminate\View\View
...
### Community 34 - "User.php"
Cohesion: 0.12
Nodes (4): ProviderWorkingHour, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\Relations\MorphOne, Illuminate\Notifications\Notifiable
...
### Community 40 - "SiteNavigationItem"
Cohesion: 0.10
Nodes (3): SiteNavigationItem, NavigationTree, Illuminate\Support\Collection
...
Cohesion: 0.09
Nodes (7): BlogStoreRequest, BlogUpdateRequest, StoreCategoryRequest, ProductStoreRequest, ProductUpdateRequest, ProjectStoreRequest, Illuminate\Foundation\Http\FormRequest
...
### Community 63 - "SiteLanguageController.php"
Cohesion: 0.13
Nodes (6): HomeSliderTranslation, SiteCounterTranslation, SiteFaqTranslation, SiteHomepageConfigTranslation, SiteNavigationItemTranslation, SiteSettingTranslation
...
Cohesion: 0.09
Nodes (6): AuthController, PasswordResetController, AdminNotificationController, ServiceReviewQuestionController, NavigationController, Illuminate\Http\Request
...
Cohesion: 0.22
Nodes (6): AvailabilityService, Carbon, DateTimeHelper, Carbon, Carbon\Carbon, Carbon\CarbonInterface
...
Cohesion: 0.24
Nodes (3): ContentPageController, Carbon, Illuminate\Support\Carbon
...
Cohesion: 0.70
Nodes (4): activateMode(), bindColorField(), init(), syncMediaField()
...
### Community 114 - "LocalizedContentTranslationService"
Cohesion: 0.13
Nodes (5): LocalizedContentTranslationService, HtmlSanitizer, DOMDocument, DOMElement, DOMNode

### Community 117 - ".schema"
Cohesion: 0.09
Nodes (20): down(), up(), down(), up(), down(), up(), down(), up() (+12 more)

### Community 121 - "Permission"
Cohesion: 0.23
Nodes (3): PermissionController, Permission, PermissionSeeder

### Community 126 - "static"
Cohesion: 0.18
Nodes (4): self, UserFactory, Illuminate\Database\Eloquent\Factories\Factory, static

### Community 130 - "Illuminate\Database\Seeder"
Cohesion: 0.21
Nodes (5): AuthSeeder, DatabaseSeeder, HomepageConfigPermissionSeeder, ServiceReviewPermissionSeeder, Illuminate\Database\Seeder
...
### Community 334 - "TestCase"
Cohesion: 0.16
Nodes (6): Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, AdminMenuVisibilityAccessTest, HomepageConfigurationTest, ServiceReviewFlowTest, TestCase
...
- **Why does `Controller` connect `Illuminate\Http\RedirectResponse` to `BlogPost`, `Illuminate\Http\JsonResponse`, `Role`, `Project`, `SiteLocalization`, `OrderController.php`, `PaymentIntegration`, `Product`, `DashController.php`, `.index`, `AppointmentController`, `ContactMessage`, `Closure`, `AppointmentCalendarController`, `TrashController`, `Category`, `AdminQuickSearchController`, `User.php`, `Media`, `HomeSlider`, `SiteNavigationItem`, `ProfileController`, `SiteSetting`, `EcommerceCoupon`, `AppointmentSettingsController`, `ProductVariant`, `SiteCounter`, `SiteLanguageController.php`, `SiteFaq`, `ServiceReviewController`, `Illuminate\Http\Request`, `Rbac.php`, `OrderController`, `ContentPageController`, `SiteLanguage`, `ServiceReview`, `Permission`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `Illuminate\Http\RedirectResponse`, `Role`, `OrderController.php`, `Member`, `AdminMenuRegistry`, `DashController.php`, `.index`, `AppointmentController`, `ContactMessage`, `Appointment`, `AppointmentCalendarController`, `Illuminate\Database\Eloquent\Builder`, `Illuminate\Bus\Queueable`, `AdminQuickSearchController`, `User.php`, `ProfileController`, `AdminNotification`, `SiteSetting`, `AppointmentSettingsController`, `ServiceReviewController`, `Illuminate\Http\Request`, `Rbac.php`, `TestCase`, `StoreContactMessageRequest`, `Illuminate\Database\Eloquent\Relations\HasMany`, `AdminSeeder.php`, `SuperAdminSeeder.php`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `Illuminate\Http\RedirectResponse`, `AdminQuickSearchController`, `BlogPost`, `Illuminate\Http\JsonResponse`, `Illuminate\Database\Eloquent\Model`, `DashController.php`, `.index`, `Illuminate\Database\Eloquent\Relations\HasMany`, `TrashController`, `Illuminate\Database\Eloquent\Builder`?**
