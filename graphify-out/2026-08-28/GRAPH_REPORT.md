...
## Summary
- 3839 nodes · 8353 edges · 405 communities (278 shown, 127 thin omitted)
...
## Communities (405 total, 127 thin omitted)

### Community 0 - "Illuminate\Http\RedirectResponse"
Cohesion: 0.14
Nodes (8): AppointmentSettingsController, Carbon, Collection, JsonResponse, Request, AppointmentMeetingMethod, HasMany, GlobalBlackout
...
Cohesion: 0.08
Nodes (9): CategoryController, JsonResponse, Request, View, StoreCategoryRequest, UpdateCategoryRequest, CategoryTree, Collection (+1 more)
...
Cohesion: 0.12
Nodes (7): HomepageConfigurationController, RedirectResponse, Request, View, HomeController, View, HomepageConfigurationService
...
### Community 12 - "Member"
Cohesion: 0.07
Nodes (61): BelongsTo, SiteHomepageSectionItemTranslation, applyScheduleTemplate(), applyTemplateValue(), applyWorkingHourRowState(), BLOCK_META, blockMeta(), collectDays() (+53 more)
...
Cohesion: 0.07
Nodes (17): Category, BelongsTo, HasMany, CategoryTranslation, BelongsTo, AdminDashboardPreference, BelongsTo, EcommerceOrderItem (+9 more)
...
### Community 38 - "Media"
Cohesion: 0.11
Nodes (10): SendAppointmentAdminNotificationMailJob, Appointment, BelongsTo, HasMany, HasOne, MorphOne, self, AppointmentService (+2 more)
...
Cohesion: 0.06
Nodes (17): TrashPurgeCommand, MediaController, JsonResponse, Request, Request, ProfileController, JsonResponse, Request (+9 more)
...
Cohesion: 0.08
Nodes (14): PermissionController, Request, Request, UserController, Permission, Rbac, AdminSeeder, AuthSeeder (+6 more)
...
Cohesion: 0.12
Nodes (7): AppServiceProvider, BaseTestCase, Notifiable, RefreshDatabase, ServiceProvider, MediaServiceWebpTest, TestCase
...
### Community 131 - ".show"
Cohesion: 0.21
Nodes (8): Controller, PageController, View, View, ServiceController, AuthorizesRequests, BaseController, ValidatesRequests
...
Cohesion: 0.08
Nodes (8): Request, RoleController, Role, AdminRoleProfile, AdminLoginBrandingTest, AdminRoleProfileTest, HomepageConfigurationTest, SiteServicesAndConsultationTest
...
Cohesion: 0.20
Nodes (8): RedirectResponse, Request, View, SiteLanguageController, BelongsTo, SiteCounterTranslation, Builder, SiteLanguage
...
- **Why does `Controller` connect `.show` to `Illuminate\Http\RedirectResponse`, `BlogPost`, `2025_12_27_133604_create_galleryables_table.php`, `calendar.js`, `Role`, `ProductGalleryController`, `Illuminate\Database\Eloquent\Model`, `PaymentIntegration`, `2026_04_22_000005_create_site_pages_table.php`, `admin/pages/index.js`, `AdminMenuRegistry`, `2026_04_22_000008_create_site_navigation_items_table.php`, `.index`, `blog/form-shared.js`, `ContactMessage`, `Closure`, `products/form-shared.js`, `AdminDashboardPreference.php`, `appointments/index.js`, `Category`, `AdminQuickSearchController`, `.managerView`, `HomepageConfigurationService`, `projects/create.blade.php`, `Illuminate\Foundation\Http\FormRequest`, `AdminNotification`, `up`, `EcommerceCoupon`, `AppointmentSettingsController`, `MediaService`, `What You Must Do When Invoked`, `SiteSettingsController.php`, `blog/index.js`, `orders/form.js`, `featured-image-manager.js`, `SiteFaq`, `composer.json`, `date-input.js`, `datatable-helper.js`, `gallery-manager.js`, `Plan 001: Site tasarım temelini kur — fontlar, OKLCH token katmanı, Tailwind @theme eşlemesi, motion altyapısı`, `require-dev`, `settings/edit.js`, `media-upload-modal.js`, `ContentPageController`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `initSliderForm`, `MemberDocumentService`, `galleries/edit.js`, `psr-4`, `require`, `projects/partials/_form.blade.php`, `2025_12_14_192415_create_blog_posts_table.php`, `2025_12_16_142024_create_categories_table.php`, `2025_12_16_142051_create_categorizables_table.php`, `site_homepage.php`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `Media` connect `featured-image-manager.js` to `BlogPost`, `PaymentWebhookEvent`, `require`, `datatable-helper.js`, `Illuminate\Database\Eloquent\Model`, `swal-alert.js`, `admin/pages/index.js`, `SiteSetting`, `Product`, `2026_04_22_000008_create_site_navigation_items_table.php`, `LocalizedContentTranslationService`, `.index`, `ContactMessage`, `AdminDashboardPreference.php`, `2025_12_14_192415_create_blog_posts_table.php`, `static`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `User` connect `.index` to `Illuminate\Http\RedirectResponse`, `2025_12_27_133604_create_galleryables_table.php`, `2026_04_22_000005_create_site_pages_table.php`, `admin/pages/index.js`, `2026_04_22_000008_create_site_navigation_items_table.php`, `AdminMenuRegistry`, `LocalizedContentTranslationService`, `ContactMessage`, `Closure`, `Appointment`, `AdminDashboardPreference.php`, `AppointmentCalendarController`, `EcommerceOrderItem.php`, `EcommerceOrderStatusHistory.php`, `Illuminate\Bus\Queueable`, `HomepageConfigurationService`, `Media`, `Illuminate\Database\Eloquent\Builder`, `AppointmentSettingsController`, `MediaService`, `featured-image-manager.js`, `composer.json`, `date-input.js`, `categories/index.js`, `Plan 001: Site tasarım temelini kur — fontlar, OKLCH token katmanı, Tailwind @theme eşlemesi, motion altyapısı`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `galleries/edit.js`, `projects/partials/_form.blade.php`, `PaymentWebhookEvent`?**
