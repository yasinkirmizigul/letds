...
## Corpus Check
- 599 files · ~222,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3492 nodes · 7386 edges · 400 communities (262 shown, 138 thin omitted)
...
## Communities (400 total, 138 thin omitted)
...
Cohesion: 0.06
Nodes (76): BelongsTo, SiteHomepageSectionItemTranslation, addDays(), addMonths(), createTimelineToolbar(), dateKey(), dateParts(), defaultAnchorForView() (+68 more)
...
Cohesion: 0.09
Nodes (11): EcommerceOrderItem, BelongsTo, Galleryable, MediaTranslation, BelongsTo, HasMany, SiteHomepageConfig, BelongsTo (+3 more)
...
Cohesion: 0.05
Nodes (31): init(), closeModal(), init(), openModal(), init(), init(), NoopPage(), registerPages() (+23 more)
...
Cohesion: 0.15
Nodes (12): SendAppointmentUpdatedMailJob, SendContactMessageReceivedMailJob, AdminAppointmentNotificationMail, AdminContactMessageReceivedMail, AppointmentUpdatedMail, SiteMailTestMail, Dispatchable, InteractsWithQueue (+4 more)
...
Cohesion: 0.38
Nodes (3): Carbon, EcommerceOrderStatusHistory, BelongsTo
...
Cohesion: 0.06
Nodes (45): HomeSliderController, JsonResponse, RedirectResponse, Request, View, HomeSlider, BelongsTo, Builder (+37 more)
...
Cohesion: 0.24
Nodes (3): AppointmentSlot, BelongsTo, HasFactory
...
Cohesion: 0.13
Nodes (12): RedirectResponse, Request, View, SiteLanguageController, HomeSliderTranslation, BelongsTo, BelongsTo, SiteFaqTranslation (+4 more)
...
Cohesion: 0.05
Nodes (17): BlogPostController, JsonResponse, RedirectResponse, Request, View, BlogStoreRequest, BlogUpdateRequest, BlogPost (+9 more)

### Community 53 - "trash/index.js"
Cohesion: 0.31
Nodes (3): OrderController, RedirectResponse, Request

### Community 54 - "app-init.js"
Cohesion: 0.24
Nodes (9): AppInit(), createCtx(), getPageName(), getPageRoot(), initKtUi(), enhance, _ranFor, _registry (+1 more)
...
Cohesion: 0.16
Nodes (7): RedirectResponse, Request, View, SiteSettingsController, HasMany, SiteSetting, SiteMailConfigurator
...
### Community 148 - "EcommerceOrderItem.php"
Cohesion: 0.36
...
- **Why does `Controller` connect `0001_01_01_000000_create_users_table.php` to `Illuminate\Http\RedirectResponse`, `BlogPost`, `.show`, `AuditEvent`, `Role`, `ProjectStoreRequest`, `PaymentIntegration`, `.now`, `Product`, `AdminMenuRegistry`, `2026_04_22_000010_create_home_sliders_table.php`, `.index`, `AppointmentController`, `EcommerceOrderItem.php`, `CategoryTranslation.php`, `AppointmentCalendarController`, `EcommerceInvoice`, `Illuminate\Support\Collection`, `ServiceReviewQuestion`, `Category`, `AdminQuickSearchController`, `projects/index.js`, `Media`, `HomeSlider`, `Illuminate\Database\Eloquent\Builder`, `products/index.js`, `ProfileController`, `Illuminate\Foundation\Http\FormRequest`, `TestCase`, `EcommerceCoupon`, `MediaService`, `trash/index.js`, `SiteSettingsController.php`, `create-form-accordion.js`, `SiteFaq`, `admin/modules/messages.php`, `AdminResetPasswordNotification.php`, `Illuminate\Http\Request`, `StoreContactMessageRequest`, `0001_01_01_000005_create_permission_role_table.php`, `ContentPageController`, `config`, `MemberDocumentService`, `psr-4`, `require`, ``appointments``, `post-create-project-cmd`, `2026_08_01_000002_create_site_homepage_configs_table.php`, `ServiceReview`, `HtmlSanitizer`, `2026_04_30_000001_add_section_order_to_admin_dashboard_preferences_table.php`, `2026_08_01_000001_create_service_review_tables.php`, `0001_01_01_000004_create_permissions_table.php`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `Media` connect `Media` to `AdminQuickSearchController`, `.show`, `SeoFileGenerator`, `HomepageConfigurationService`, `Role`, `Project`, `Illuminate\Database\Eloquent\Model`, `ProfileController`, `EcommerceCoupon`, `.index`, `MediaService`, `AppointmentSettingsController`, `create-form-accordion.js`, `Illuminate\Support\Collection`, `static`, `Category`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `Product` connect `Product` to `AdminQuickSearchController`, `psr-4`, `Illuminate\Database\Eloquent\Model`, `2026_08_01_000002_create_site_homepage_configs_table.php`, `homepage/edit.js`, `extra`, `EcommerceCoupon`, `.index`, `AppointmentController`, `trash/index.js`, `AppointmentSettingsController`, `2026_05_06_000001_create_admin_notifications_table.php`, `Illuminate\Support\Collection`, `.formPayload`?**
