# Graph Report - letds  (2026-09-23)

## Corpus Check
- 653 files · ~253,408 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3864 nodes · 8397 edges · 407 communities (280 shown, 127 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 706 edges (avg confidence: 0.79)
...
Cohesion: 0.12
Nodes (8): BlogPostController, JsonResponse, RedirectResponse, Request, BlogPost, BelongsTo, Builder, HasMany
...
### Community 18 - ".now"
Cohesion: 0.14
Nodes (8): DemoDataFactoryService, Closure, Collection, Model, down(), replaceManagedSection(), up(), updateHomepageContent()
...
Cohesion: 0.08
Nodes (7): BlogStoreRequest, BlogUpdateRequest, StoreCategoryRequest, UpdateCategoryRequest, CategoryTree, Collection, FormRequest
...
Cohesion: 0.11
Nodes (8): JsonResponse, RedirectResponse, Request, View, ProductController, Builder, Product, BelongsToMany
...
### Community 65 - "Media"
Cohesion: 0.08
Nodes (12): TrashPurgeCommand, MediaController, JsonResponse, Request, Request, ProfileController, Media, HasMany (+4 more)
...
Cohesion: 0.10
Nodes (7): ContactMessageController, RedirectResponse, View, AppointmentObserver, EcommerceOrderObserver, Notifiable, ShouldHandleEventsAfterCommit
...
Cohesion: 0.08
Nodes (9): BaseTestCase, RefreshDatabase, AdminDashboardLayoutTest, AdminLoginBrandingTest, MediaServiceWebpTest, TestCase, AdminFormControlMarkupTest, FaviconAssetsTest (+1 more)
...
Cohesion: 0.07
Nodes (18): PageController, View, HomeController, View, CategoryTranslation, BelongsTo, EcommerceOrderStatusHistory, BelongsTo (+10 more)
...
Cohesion: 0.02
Nodes (92): down(), up(), down(), up(), down(), up(), down(), up() (+84 more)

### Community 150 - "reset-password.blade.php"
Cohesion: 0.13
Nodes (12): BlogPostGalleryController, JsonResponse, Request, JsonResponse, Request, TinyMceController, Controller, View (+4 more)
...
### Community 159 - "0001_01_01_000000_create_users_table.php"
Cohesion: 0.43
...
- **Why does `Controller` connect `reset-password.blade.php` to `AppointmentSettingsController`, `BlogPost`, `UserController`, `CategoryController`, `0001_01_01_000002_create_jobs_table.php`, `HomepageConfigurationService`, `PaymentIntegration`, `.index`, `Role`, `User`, `Product`, `Category`, `SiteSetting`, `SiteHomepageSection`, `SiteLanguage`, `member-forgot-password.blade.php`, `Illuminate\Console\Command`, `products/index.js`, `Illuminate\Http\JsonResponse`, `AuditEvent`, `AdminMenuRegistry`, `ModuleGenerator`, `ContentPageController`, `EcommerceInvoice`, `AppointmentCalendarController`, `Illuminate\Http\Request`, `require-dev`, `SiteFaq`, `CategoryTree`, `Illuminate\Database\Eloquent\Builder`, `Media`, `AdminQuickSearchController`, `AdminNotification`, `EcommerceCoupon`, `Illuminate\Foundation\Http\FormRequest`, `static`, `Illuminate\Database\Eloquent\Model`, `StoreContactMessageRequest`, `config`, `Carbon\Carbon`, `BlogStoreRequest`, `ProjectFile`, `AppointmentController`, `.stats`, ``appointments``, `post-create-project-cmd`, `blog/index.js`, `password-confirmation.js`, `autoload-dev`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `HomepageConfigurationTest`, `2025_12_14_192415_create_blog_posts_table.php`, `MemberDocumentService`, `GalleryController.php`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `Media` connect `Media` to `SitePortalFlowTest`, `Controller`, `Illuminate\Database\Eloquent\Model`, `.index`, `config`, `Project`, `Permission`, `.now`, `User`, `Product`, `create-form-accordion.js`, `BlogStoreRequest`, `member-forgot-password.blade.php`, `MemberDocumentService`, `member-reset-password.blade.php`, `products/index.js`, `ServiceReviewAssignmentService`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `2026_05_06_000002_enhance_contact_messages_workflow.php`, `.index`, `Role`, `SiteNavigationItem`, `.now`, `SiteSetting`, `Member`, `ajax-forms.js`, `ContactMessage`, `AdminMenuRegistry`, `Appointment`, `SitePage.php`, `ServiceReviewFlowTest`, `AppointmentCalendarController`, `Illuminate\Database\Eloquent\Builder`, `Media`, `AdminQuickSearchController`, `Illuminate\Database\Eloquent\Model`, `Permission`, `create-form-accordion.js`, `Carbon\Carbon`, `BlogStoreRequest`, `UpdateCategoryRequest`, ``appointments``, `HomepageConfigurationTest`, `2025_12_14_192415_create_blog_posts_table.php`, `SitePortalFlowTest`, `ServiceReviewItem`?**
