...
## Corpus Check
- 647 files · ~251,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3847 nodes · 8358 edges · 436 communities (280 shown, 156 thin omitted)
...
## Communities (436 total, 156 thin omitted)

### Community 0 - "Illuminate\Http\RedirectResponse"
Cohesion: 0.06
Nodes (17): AppointmentSettingsController, Carbon, Collection, JsonResponse, Request, AppointmentController, Request, AppointmentMeetingMethod (+9 more)
...
Cohesion: 0.06
Nodes (28): down(), up(), down(), up(), down(), up(), down(), up() (+20 more)
...
### Community 6 - "Role"
Cohesion: 0.20
Nodes (5): OrderController, Carbon, RedirectResponse, Request, View
...
Cohesion: 0.05
Nodes (31): init(), init(), init(), init(), NoopPage(), registerPages(), init(), init() (+23 more)
...
### Community 19 - ".index"
Cohesion: 0.08
Nodes (8): AdminQuickSearchController, JsonResponse, Request, Builder, HasMany, HasOne, self, User

### Community 20 - "blog/form-shared.js"
Cohesion: 0.11
Nodes (7): JsonResponse, RedirectResponse, Request, View, ProductController, ProductStoreRequest, ProductUpdateRequest

### Community 21 - "ContactMessage"
Cohesion: 0.11
Nodes (7): ContactMessageController, RedirectResponse, View, BelongsTo, ProviderWorkingHour, HasFactory, Notifiable
...
Cohesion: 0.07
Nodes (8): ContactMessageController, JsonResponse, RedirectResponse, Request, View, ContactMessage, BelongsTo, Builder

### Community 31 - "Category"
Cohesion: 0.21
Nodes (4): GalleryController, JsonResponse, Request, AuditEvent
...
### Community 38 - "Media"
Cohesion: 0.10
Nodes (9): Appointment, BelongsTo, HasMany, HasOne, MorphOne, self, AppServiceProvider, HasLocalDateTimes (+1 more)
...
Cohesion: 0.15
Nodes (27): init(), init(), notify(), clampTextLength(), countWords(), csrfToken(), debounce(), getTheme() (+19 more)
...
Cohesion: 0.08
Nodes (30): Collection, SeoFileGenerator, createBlogFilter(), createPopover(), hideImgPopover(), init(), notify(), postJson() (+22 more)
...
Cohesion: 0.06
Nodes (27): CouponController, RedirectResponse, Request, View, InventoryController, JsonResponse, RedirectResponse, Request (+19 more)
...
Cohesion: 0.11
Nodes (5): BelongsTo, Builder, HasMany, SitePage, Request

### Community 53 - "trash/index.js"
Cohesion: 0.09
Nodes (15): Builder, RedirectResponse, Request, View, ServiceReviewController, RedirectResponse, Request, View (+7 more)
...
Cohesion: 0.13
Nodes (5): BelongsTo, ServiceReviewItem, Builder, HasMany, ServiceReviewQuestion
...
Cohesion: 0.38
Nodes (3): Collection, NavigationTree, Collection
...
Cohesion: 0.19
Nodes (9): GalleryItemsController, JsonResponse, Request, Gallery, Builder, HasMany, HasOne, GalleryItem (+1 more)
...
Cohesion: 0.16
Nodes (4): Builder, SiteLanguage, Collection, SiteLocalization

### Community 76 - "Plan 001: Site tasarım temelini kur — fontlar, OKLCH token katmanı, Tailwind @theme eşlemesi, motion altyapısı"
Cohesion: 0.33
Nodes (4): RedirectResponse, Request, View, SiteLanguageController
...
Cohesion: 0.16
Nodes (6): AdminRoleProfile, AdminSeeder, AuthSeeder, DatabaseSeeder, PermissionSeeder, Seeder
...
Cohesion: 0.35
Nodes (4): RedirectResponse, Request, View, ServiceReviewQuestionController
...
Cohesion: 0.15
Nodes (6): PermissionController, Request, Permission, Rbac, HomepageConfigPermissionSeeder, ServiceReviewPermissionSeeder
...
Cohesion: 0.12
Nodes (6): BaseTestCase, AdminMenuVisibilityAccessTest, TestCase, AdminFormControlMarkupTest, AdminMenuRegistryTest, FaviconAssetsTest

### Community 131 - ".show"
Cohesion: 0.13
Nodes (13): HomepageConfigurationController, RedirectResponse, Request, View, Controller, View, ServiceController, GalleryController (+5 more)
...
Cohesion: 0.83
Nodes (3): localizedValue(), Model, translationFor()
...
Cohesion: 0.17
Nodes (5): Request, RoleController, Role, AdminRoleProfileTest, SiteServicesAndConsultationTest
...
Cohesion: 0.11
Nodes (9): PageController, View, HomeController, View, Galleryable, HasMany, SiteHomepageConfig, HasSiteLocaleTranslations (+1 more)
...
### Community 156 - "EcommerceOrderItem.php"
Cohesion: 0.14
Nodes (4): RefreshDatabase, GuardIntendedUrlIsolationTest, MediaServiceWebpTest, SiteNavigationManagementTest
...
Cohesion: 0.19
Nodes (6): HomeSliderTranslation, BelongsTo, BelongsTo, SiteCounterTranslation, BelongsTo, SiteSettingTranslation
...
### Community 191 - "EnsureActiveMemberSession.php"
Cohesion: 0.18
Nodes (5): TrashPurgeCommand, Category, BelongsTo, HasMany, SoftDeletes
...
## Knowledge Gaps
- **381 isolated node(s):** `$schema`, `name`, `type`, `description`, `keywords` (+376 more)
...
- **Why does `Controller` connect `.show` to `Illuminate\Http\RedirectResponse`, `BlogPost`, `calendar.js`, `Role`, `PaymentIntegration`, `admin/pages/index.js`, `AdminMenuRegistry`, `2026_04_22_000008_create_site_navigation_items_table.php`, `.index`, `blog/form-shared.js`, `ContactMessage`, `Closure`, `products/form-shared.js`, `AdminDashboardPreference.php`, `appointments/index.js`, `Illuminate\Bus\Queueable`, `Category`, `AdminQuickSearchController`, `HomepageConfigurationService`, `Illuminate\Database\Eloquent\Builder`, `Illuminate\Foundation\Http\FormRequest`, `AdminNotification`, `EcommerceCoupon`, `AppointmentSettingsController`, `trash/index.js`, `What You Must Do When Invoked`, `SiteSettingsController.php`, `blog/index.js`, `orders/form.js`, `EnsureActiveMemberSession.php`, `featured-image-manager.js`, `SiteFaq`, `date-input.js`, `datatable-helper.js`, `gallery-manager.js`, `Plan 001: Site tasarım temelini kur — fontlar, OKLCH token katmanı, Tailwind @theme eşlemesi, motion altyapısı`, `settings/edit.js`, `media-upload-modal.js`, `OrderController`, `ContentPageController`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `initSliderForm`, `MemberDocumentService`, `galleries/edit.js`, `psr-4`, `require`, `projects/partials/_form.blade.php`, `navigation/index.js`, `2025_12_14_192415_create_blog_posts_table.php`, `2025_12_16_142024_create_categories_table.php`, `site_homepage.php`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `Media` connect `featured-image-manager.js` to `BlogPost`, `Illuminate\Database\Eloquent\Model`, `admin/pages/index.js`, `Product`, `LocalizedContentTranslationService`, `.index`, `AdminDashboardPreference.php`, `SiteHomepageSectionTranslation.php`, `SiteSetting`, `EnsureActiveMemberSession.php`, `SiteFaq`, `datatable-helper.js`, `swal-alert.js`, `require`, ``appointments``, `autoload-dev`, `PaymentWebhookEvent`, `2025_12_14_192415_create_blog_posts_table.php`, `static`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `User` connect `.index` to `Illuminate\Http\RedirectResponse`, `admin/pages/index.js`, `2026_04_22_000008_create_site_navigation_items_table.php`, `LocalizedContentTranslationService`, `ContactMessage`, `Closure`, `Appointment`, `AppointmentCalendarController`, `EcommerceOrderItem.php`, `Illuminate\Bus\Queueable`, `HomepageConfigurationService`, `projects/index.js`, `SiteHomepageSectionTranslation.php`, `up`, `AppointmentSettingsController`, `.run`, `trash/index.js`, `EnsureActiveMemberSession.php`, `SiteFaq`, `date-input.js`, `categories/index.js`, `admin-quick-search.js`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `galleries/edit.js`, `projects/partials/_form.blade.php`, `navigation/index.js`, ``appointments``, `autoload-dev`, `PaymentWebhookEvent`?**
