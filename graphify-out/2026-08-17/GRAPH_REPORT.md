...
## Corpus Check
- 627 files · ~243,330 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3723 nodes · 8097 edges · 408 communities (271 shown, 137 thin omitted)
...
## Communities (408 total, 137 thin omitted)
...
Cohesion: 0.06
Nodes (27): init(), init(), init(), init(), NoopPage(), registerPages(), init(), init() (+19 more)
...
Cohesion: 0.11
Nodes (6): EcommerceOrderItem, BelongsTo, Galleryable, HasSiteLocaleTranslations, Model, SoftDeletes
...
Cohesion: 0.12
Nodes (6): BaseTestCase, AdminLoginBrandingTest, AdminMenuVisibilityAccessTest, MediaServiceWebpTest, TestCase, AdminMenuRegistryTest
...
Cohesion: 0.09
Nodes (8): PermissionController, Request, Request, RoleController, Role, Rbac, AdminRoleProfileTest, HomepageConfigurationTest
...
### Community 38 - "Media"
Cohesion: 0.09
Nodes (11): Appointment, BelongsTo, HasMany, HasOne, MorphOne, self, AppointmentObserver, EcommerceOrderObserver (+3 more)
...
Cohesion: 0.09
Nodes (12): Permission, AdminRoleProfile, AdminSeeder, AuthSeeder, DatabaseSeeder, HomepageConfigPermissionSeeder, PermissionSeeder, ServiceReviewPermissionSeeder (+4 more)
...
Cohesion: 0.15
Nodes (11): Controller, PageController, View, GalleryController, Request, View, HomeController, View (+3 more)
...
Cohesion: 0.54
Nodes (7): announce(), createLayoutRow(), init(), initLayoutBuilder(), moveItem(), qs(), qsa()
...
- **Why does `Controller` connect `post-create-project-cmd` to `Illuminate\Http\RedirectResponse`, `BlogPost`, `calendar.js`, `Illuminate\Database\Eloquent\Model`, `PaymentIntegration`, `admin/pages/index.js`, `AdminMenuRegistry`, `SiteSettingsController.php`, `blog/form-shared.js`, `ContactMessage`, `Closure`, `projects/form-shared.js`, `appointments/index.js`, `ServiceReviewQuestion`, `Category`, `AdminQuickSearchController`, `HomepageConfigurationService`, `SeoFileGenerator`, `HomeSlider`, `Illuminate\Foundation\Http\FormRequest`, `up`, `EcommerceCoupon`, `AppointmentSettingsController`, `MediaService`, `What You Must Do When Invoked`, `SiteSettingsController.php`, `blog/index.js`, `create-form-accordion.js`, `scripts`, `Theme Tailwind HTML Laravel Integration`, `featured-image-manager.js`, `date-input.js`, `datatable-helper.js`, `categories/index.js`, `gallery-manager.js`, `require-dev`, `settings/edit.js`, `roles/create.js`, `media-upload-modal.js`, `ContentPageController`, `initSliderForm`, `galleries/edit.js`, `psr-4`, `require`, `projects/partials/_form.blade.php`, ``appointments``, `2026_08_01_000002_create_site_homepage_configs_table.php`, `ServiceReview`, `extra`, `2025_12_14_192415_create_blog_posts_table.php`, `2025_12_16_142024_create_categories_table.php`, `2025_12_16_142051_create_categorizables_table.php`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `Media` connect `Illuminate\Database\Eloquent\Model` to `BlogPost`, `calendar.js`, `Project`, `admin/pages/index.js`, `Product`, `settings.js`, `LocalizedContentTranslationService`, `ContactMessage`, `products/form-shared.js`, `ServiceReviewQuestion`, `HomeSlider`, `Illuminate\Database\Eloquent\Builder`, `AdminNotification`, `AppointmentSettingsController`, `SiteFaq`, `datatable-helper.js`, `roles/create.js`, `PaymentWebhookEvent`, `static`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `User` connect `.index` to `Illuminate\Http\RedirectResponse`, `admin/pages/index.js`, `AdminMenuRegistry`, `settings.js`, `LocalizedContentTranslationService`, `SiteSettingsController.php`, `ContactMessage`, `Closure`, `Appointment`, `products/form-shared.js`, `projects/form-shared.js`, `AppointmentCalendarController`, `ServiceReviewQuestion`, `Illuminate\Bus\Queueable`, `HomepageConfigurationService`, `products/create.blade.php`, `Media`, `HomeSlider`, `AppointmentSettingsController`, `create-form-accordion.js`, `orders/form.js`, `featured-image-manager.js`, `date-input.js`, `settings/edit.js`, `ContentPageController`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `initSliderForm`, `load-script-once.js`, `projects/partials/_form.blade.php`, ``appointments``, `PaymentWebhookEvent`?**
