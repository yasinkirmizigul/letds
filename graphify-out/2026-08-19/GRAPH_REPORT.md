...
## Corpus Check
- 638 files · ~247,405 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3783 nodes · 8228 edges · 425 communities (276 shown, 149 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 690 edges (avg confidence: 0.79)
...
Cohesion: 0.05
Nodes (17): CategoryController, JsonResponse, Request, View, JsonResponse, Request, TrashController, StoreCategoryRequest (+9 more)
...
Cohesion: 0.07
Nodes (27): AdminMiddleware, Closure, Request, AjaxRedirectResponseMiddleware, Closure, Request, Response, DemoAccessMiddleware (+19 more)
...
Cohesion: 0.08
Nodes (9): BaseTestCase, RefreshDatabase, AdminDashboardLayoutTest, AdminLoginBrandingTest, AdminMenuVisibilityAccessTest, MediaServiceWebpTest, SiteNavigationManagementTest, SiteServicesAndConsultationTest (+1 more)
...
Cohesion: 0.12
Nodes (5): Request, RoleController, Role, AdminRoleProfileTest, HomepageConfigurationTest
...
Cohesion: 0.16
Nodes (26): bindActiveAppointmentActions(), bindStepperControls(), calendarSkeletonCells(), cancelAppointment(), confirmBooking(), confirmReschedule(), createSlotElement(), currentMonth (+18 more)
...
Cohesion: 0.11
Nodes (13): Controller, PageController, View, View, ServiceController, ContactMessageController, RedirectResponse, View (+5 more)
...
### Community 178 - "SiteSettingTranslation.php"
Cohesion: 0.83
...
- **Why does `Media` connect `Illuminate\Database\Eloquent\Model` to `BlogPost`, `calendar.js`, `Project`, `admin/pages/index.js`, `Product`, `settings.js`, `LocalizedContentTranslationService`, `ContactMessage`, `projects/form-shared.js`, `SeoFileGenerator`, `HomeSlider`, `HomeSliderTranslation.php`, `MediaService`, `SiteFaq`, `datatable-helper.js`, `roles/create.js`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `PaymentWebhookEvent`, `static`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `Controller` connect `2025_12_16_142051_create_categorizables_table.php` to `Illuminate\Http\RedirectResponse`, `BlogPost`, `calendar.js`, `ProductGalleryController`, `Illuminate\Database\Eloquent\Model`, `PaymentIntegration`, `admin/pages/index.js`, `AdminMenuRegistry`, `.index`, `blog/form-shared.js`, `ContactMessage`, `Closure`, `products/form-shared.js`, `projects/form-shared.js`, `appointments/index.js`, `ServiceReviewQuestion`, `Illuminate\Bus\Queueable`, `Category`, `AdminQuickSearchController`, `HomepageConfigurationService`, `SeoFileGenerator`, `projects/create.blade.php`, `HomeSlider`, `Illuminate\Database\Eloquent\Builder`, `Illuminate\Foundation\Http\FormRequest`, `up`, `EcommerceCoupon`, `AppointmentSettingsController`, `What You Must Do When Invoked`, `SiteSettingsController.php`, `blog/index.js`, `orders/form.js`, `Theme Tailwind HTML Laravel Integration`, `featured-image-manager.js`, `GalleryController.php`, `datatable-helper.js`, `categories/index.js`, `gallery-manager.js`, `require-dev`, `media/index.js`, `roles/create.js`, `media-upload-modal.js`, `ContentPageController`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `initSliderForm`, `MemberDocumentService`, `galleries/edit.js`, `psr-4`, `projects/partials/_form.blade.php`, ``appointments``, `ServiceReview`, `extra`, `2025_12_16_142024_create_categories_table.php`, `site_homepage.php`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `User` connect `.index` to `Illuminate\Http\RedirectResponse`, `admin/pages/index.js`, `settings.js`, `LocalizedContentTranslationService`, `ContactMessage`, `Closure`, `Appointment`, `CategoryTranslation.php`, `projects/form-shared.js`, `AppointmentCalendarController`, `ServiceReviewQuestion`, `Illuminate\Bus\Queueable`, `Illuminate\Support\Collection`, `HomepageConfigurationService`, `SeoFileGenerator`, `Media`, `HomeSlider`, `HomeSliderTranslation.php`, `AppointmentSettingsController`, `scripts`, `featured-image-manager.js`, `categories/index.js`, `media/index.js`, `galleries/edit.js`, `projects/partials/_form.blade.php`, `PaymentWebhookEvent`, `2025_12_16_142051_create_categorizables_table.php`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Are the 25 inferred relationships involving `User` (e.g. with `.index()` and `.show()`) actually correct?**
