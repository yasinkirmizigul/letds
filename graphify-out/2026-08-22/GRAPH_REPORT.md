# Graph Report - letds  (2026-08-22)

## Corpus Check
- 641 files · ~249,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3807 nodes · 8296 edges · 431 communities (276 shown, 155 thin omitted)
...
- [[_COMMUNITY_media.php|media.php]]
- [[_COMMUNITY_2025_12_27_133537_create_gallery_items_table.php|2025_12_27_133537_create_gallery_items_table.php]]
...
## Communities (431 total, 155 thin omitted)
...
### Community 6 - "Role"
Cohesion: 0.08
Nodes (6): EcommerceOrder, BelongsTo, Builder, HasMany, MorphOne, EcommerceOrderObserver
...
Cohesion: 0.08
Nodes (10): BelongsTo, Builder, Collection, HasMany, SiteNavigationItem, AppServiceProvider, NavigationTree, Collection (+2 more)
...
Cohesion: 0.13
Nodes (7): BaseTestCase, Notifiable, RefreshDatabase, AdminDashboardLayoutTest, MediaServiceWebpTest, SiteNavigationManagementTest, TestCase
...
Cohesion: 0.09
Nodes (11): ContentPageController, Carbon, JsonResponse, RedirectResponse, Request, View, BelongsTo, Builder (+3 more)
...
Cohesion: 0.06
Nodes (20): CategoryTranslation, BelongsTo, EcommerceOrderItem, BelongsTo, EcommerceOrderStatusHistory, BelongsTo, Galleryable, MediaTranslation (+12 more)
...
Cohesion: 0.19
Nodes (5): localizedValue(), Model, translationFor(), Collection, SiteLocalization
...
Cohesion: 0.31
Nodes (5): RedirectResponse, Request, View, ServiceReviewController, ServiceReviewAssignmentService
...
Cohesion: 0.10
Nodes (6): Request, RoleController, Role, AdminRoleProfileTest, HomepageConfigurationTest, SiteServicesAndConsultationTest
...
### Community 153 - ".featuredMediaOne"
Cohesion: 0.25
...
### Community 200 - "permissions/index.blade.php"
Cohesion: 0.28
Nodes (4): BelongsTo, SiteFaqTranslation, BelongsTo, SiteSettingTranslation
...
- **Why does `Controller` connect `GalleryController.php` to `Illuminate\Http\RedirectResponse`, `BlogPost`, `calendar.js`, `Illuminate\Database\Eloquent\Model`, `PaymentIntegration`, `admin/pages/index.js`, `settings.js`, `blog/form-shared.js`, `ContactMessage`, `Closure`, `products/form-shared.js`, `appointments/index.js`, `Illuminate\Support\Collection`, `AdminLoginBrandingTest`, `Category`, `AdminQuickSearchController`, `HomepageConfigurationService`, `SeoFileGenerator`, `projects/create.blade.php`, `HomeSlider`, `Illuminate\Database\Eloquent\Builder`, `navigation/index.blade.php`, `Illuminate\Foundation\Http\FormRequest`, `DateTimeHelper`, `up`, `EcommerceCoupon`, `AppointmentSettingsController`, `What You Must Do When Invoked`, `SiteSettingsController.php`, `blog/index.js`, `orders/form.js`, `Theme Tailwind HTML Laravel Integration`, `featured-image-manager.js`, `datatable-helper.js`, `categories/index.js`, `gallery-manager.js`, `swal-alert.js`, `Plan 001: Site tasarım temelini kur — fontlar, OKLCH token katmanı, Tailwind @theme eşlemesi, motion altyapısı`, `media/index.js`, `roles/create.js`, `media-upload-modal.js`, `OrderController`, `ContentPageController`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `initSliderForm`, `MemberDocumentService`, `galleries/edit.js`, `psr-4`, `projects/partials/_form.blade.php`, ``appointments``, `2026_08_01_000002_create_site_homepage_configs_table.php`, `ServiceReview`, `extra`, `2025_12_14_192415_create_blog_posts_table.php`, `2025_12_16_142024_create_categories_table.php`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `Media` connect `Illuminate\Database\Eloquent\Model` to `BlogPost`, `.show`, `admin/pages/index.js`, `Product`, `settings.js`, `LocalizedContentTranslationService`, `ContactMessage`, `SeoFileGenerator`, `.translations`, `SiteSetting`, `MediaService`, `scripts`, `categories/create.blade.php`, `SiteFaq`, `datatable-helper.js`, `swal-alert.js`, `roles/create.js`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `PaymentWebhookEvent`, `2025_12_14_192415_create_blog_posts_table.php`, `static`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `User` connect `.index` to `Illuminate\Http\RedirectResponse`, `.show`, `2026_02_15_000002_create_category_product_table.php`, `AdminMenuRegistryTest`, `admin/pages/index.js`, `settings.js`, `LocalizedContentTranslationService`, `ContactMessage`, `Closure`, `Appointment`, `CategoryTranslation.php`, `AppointmentCalendarController`, `ServiceReviewQuestion`, `Illuminate\Support\Collection`, `Illuminate\Bus\Queueable`, `HomepageConfigurationService`, `SeoFileGenerator`, `Media`, `navigation/index.blade.php`, `DateTimeHelper`, `AppointmentSettingsController`, `scripts`, `categories/create.blade.php`, `categories/index.js`, `media/index.js`, `galleries/edit.js`, `projects/partials/_form.blade.php`, `2026_08_01_000002_create_site_homepage_configs_table.php`, `PaymentWebhookEvent`, `2025_12_14_192415_create_blog_posts_table.php`?**
