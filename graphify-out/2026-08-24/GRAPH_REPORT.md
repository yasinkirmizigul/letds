...
## Corpus Check
- 641 files · ~249,939 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3810 nodes · 8302 edges · 420 communities (276 shown, 144 thin omitted)
...
## Communities (420 total, 144 thin omitted)
...
Cohesion: 0.03
Nodes (56): down(), up(), down(), up(), down(), up(), down(), up() (+48 more)
...
Cohesion: 0.11
Nodes (9): ContactMessageController, RedirectResponse, View, BaseTestCase, HasFactory, Notifiable, RefreshDatabase, MediaServiceWebpTest (+1 more)
...
Cohesion: 0.13
Nodes (12): HomepageSectionController, JsonResponse, RedirectResponse, Request, View, Builder, HasMany, SiteHomepageSection (+4 more)
...
Cohesion: 0.06
Nodes (16): MediaController, JsonResponse, Request, JsonResponse, Request, TinyMceController, JsonResponse, Request (+8 more)
...
Cohesion: 0.16
Nodes (3): HomepageSectionService, Model, SiteTranslationSyncService
...
Cohesion: 0.06
Nodes (13): PermissionController, Request, Request, RoleController, Permission, Role, AdminRoleProfile, Rbac (+5 more)
...
### Community 131 - ".show"
Cohesion: 0.11
Nodes (15): HomepageConfigurationController, RedirectResponse, Request, View, Controller, FaqController, Request, View (+7 more)
...
Cohesion: 0.08
Nodes (14): CategoryTranslation, BelongsTo, EcommerceOrderItem, BelongsTo, EcommerceOrderStatusHistory, BelongsTo, Galleryable, MediaTranslation (+6 more)
...
- **Why does `Controller` connect `.show` to `Illuminate\Http\RedirectResponse`, `BlogPost`, `calendar.js`, `2026_03_28_120222_create_provider_working_hours_table.php`, `PaymentIntegration`, `admin/pages/index.js`, `settings.js`, `.index`, `blog/form-shared.js`, `ContactMessage`, `Closure`, `products/form-shared.js`, `appointments/index.js`, `Illuminate\Bus\Queueable`, `Category`, `AdminQuickSearchController`, `HomepageConfigurationService`, `SeoFileGenerator`, `projects/create.blade.php`, `HomeSlider`, `Illuminate\Foundation\Http\FormRequest`, `up`, `EcommerceCoupon`, `AppointmentSettingsController`, `MediaService`, `trash/index.js`, `What You Must Do When Invoked`, `SiteSettingsController.php`, `blog/index.js`, `scripts`, `orders/form.js`, `ContactMessageController.php`, `Theme Tailwind HTML Laravel Integration`, `featured-image-manager.js`, `SiteFaq`, `datatable-helper.js`, `categories/index.js`, `gallery-manager.js`, `roles/create.js`, `media-upload-modal.js`, `ContentPageController`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `config`, `initSliderForm`, `MemberDocumentService`, `galleries/edit.js`, `psr-4`, `require`, `projects/partials/_form.blade.php`, ``appointments``, `extra`, `2025_12_16_142024_create_categories_table.php`, `site_homepage.php`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `Media` connect `MediaService` to `BlogPost`, `calendar.js`, `SeoFileGenerator`, `require`, `datatable-helper.js`, `Illuminate\Database\Eloquent\Model`, `2026_04_22_000005_create_site_pages_table.php`, `admin/pages/index.js`, `SiteSetting`, `Product`, `settings.js`, `LocalizedContentTranslationService`, `PaymentWebhookEvent`, `create-form-accordion.js`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `ContactMessageController.php`, `static`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `User` connect `.index` to `Illuminate\Http\RedirectResponse`, `2026_04_22_000005_create_site_pages_table.php`, `admin/pages/index.js`, `AdminMenuRegistry`, `settings.js`, `LocalizedContentTranslationService`, `ContactMessage`, `Closure`, `Appointment`, `CategoryTranslation.php`, `AppointmentCalendarController`, `Illuminate\Bus\Queueable`, `HomepageConfigurationService`, `SeoFileGenerator`, `Media`, `AppointmentSettingsController`, `ContactMessageController.php`, `SiteFaq`, `AdminDashboardPreference.php`, `categories/index.js`, `swal-alert.js`, `roles/create.js`, `Plan 005: İkincil sayfaları sisteme hizala — auth, iletişim, CMS sayfası, hesap; SEO skoru sızıntısını kaldır`, `config`, `galleries/edit.js`, `projects/partials/_form.blade.php`, `PaymentWebhookEvent`, `2025_12_16_142051_create_categorizables_table.php`, `.formPayload`?**
