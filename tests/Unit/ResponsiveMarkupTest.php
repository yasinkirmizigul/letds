...
class ResponsiveMarkupTest extends TestCase
{
    ...
    public function test_public_theme_and_probablue_brand_have_responsive_styles(): void
    {
        ...
        $this->assertStringContainsString('"brand brand theme menu"', $homeCss);
        ...
        $this->assertStringNotContainsString("route('member.login'", $homeNavigation);
        $this->assertStringNotContainsString("route('member.register'", $homeNavigation);
        ...
        $this->assertStringNotContainsString("@include('site.home-sections.features'", $homeView);
        $this->assertStringNotContainsString("@include('site.home-sections.start'", $homeView);
        $this->assertStringNotContainsString("@include('site.home-sections.about-faq'", $homeView);
        $this->assertMatchesRegularExpression('/body\.site-home-index\s*\{[^}]*height:\s*100dvh;[^}]*overflow:\s*hidden;/s', $homeCss);
        $this->assertMatchesRegularExpression('/\.home-before-after\s*\{[^}]*height:\s*100dvh;[^}]*min-height:\s*0;[^}]*overflow:\s*hidden;/s', $homeCss);
        ...
        $this->assertMatchesRegularExpression('/class="view view-after".*?class="wrapper-before".*?\[\x27variant\x27 => \x27pv\x27/s', $homeView);
        $this->assertMatchesRegularExpression('/class="view view-before".*?class="wrapper-after".*?\[\x27variant\x27 => \x27pvt\x27/s', $homeView);
        $this->assertMatchesRegularExpression('/\.view-after\s*\{[^}]*background:\s*var\(--home-before-bg\);/s', $homeCss);
        $this->assertMatchesRegularExpression('/\.view-before\s*\{[^}]*background:\s*var\(--home-after-bg\);/s', $homeCss);
