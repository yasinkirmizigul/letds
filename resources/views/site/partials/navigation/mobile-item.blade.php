...
<a
    ...
    class="site-mobile-nav__link flex items-center rounded-xl px-3 py-2 text-sm font-medium {{ $itemIsCurrent ? 'site-mobile-nav__link--active bg-primary/10 text-primary' : 'text-foreground hover:bg-muted/60' }}"
>
...
@foreach($navItem->children as $childItem)
    ...
    <a
        ...
        class="site-mobile-nav__link site-mobile-nav__link--child flex items-center rounded-xl px-3 py-2 pl-7 text-sm {{ $childCurrent ? 'site-mobile-nav__link--active bg-primary/10 text-primary' : 'text-muted-foreground hover:bg-muted/60 hover:text-foreground' }}"
    >
