            ...
            <div class="grid gap-2">
                ...
                <div>
                    ...
                    <div class="text-sm text-muted-foreground">
                        Mutlu müşteri, teslim edilen proje ve benzeri metrikleri içerik sayfalarına bağla.
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="kt-card">
                ...
                <form method="POST" action="{{ route('admin.site.counters.store') }}" class="kt-card-content grid gap-4 p-6">
                    ...
                    <div class="grid gap-2">
                        ...
                        <input name="label" class="kt-input" placeholder="Örn. Mutlu Müşteri">
                    </div>

                    <div class="grid gap-4 lg:grid-cols-3">
                        <div class="grid gap-2 lg:col-span-2">
                            <label class="kt-form-label">Değer</label>
                            <input type="number" name="value" class="kt-input" min="0" value="0">
                        </div>
                        <div class="grid gap-2">
                            <label class="kt-form-label">Önek</label>
                            <input name="prefix" class="kt-input" placeholder="+">
                        </div>
                    </div>

                    <div class="grid gap-2">
                        <label class="kt-form-label">Sonek</label>
                        <input name="suffix" class="kt-input" placeholder="+">
                    </div>

                    <div class="grid gap-2">
                        <label class="kt-form-label">Açıklama</label>
                        <textarea name="description" rows="4" class="kt-textarea" placeholder="Sayaç kartının alt açıklaması"></textarea>
                    </div>

                    <div class="grid gap-2">
                        <label class="kt-form-label">İkon</label>
                        <input name="icon_class" class="kt-input" value="ki-filled ki-chart-simple">
                    </div>

                    <label class="flex items-start gap-3 rounded-2xl app-surface-card app-surface-card--soft p-4">
                        <input type="hidden" name="is_active" value="0">
                        <input type="checkbox" name="is_active" value="1" class="kt-checkbox mt-1" checked>
                        <span>
