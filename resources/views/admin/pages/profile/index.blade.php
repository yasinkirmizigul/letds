...
@section('content')
    @php
        ...
        // DB'de avatar kolonu yoksa statik kullan.
        $avatarUrl  = asset('assets/media/avatars/300-1.png');

        // DB'de company/location yok => UI alanını tut ama placeholder göster.
        $company    = '—';
        $location   = '—';
    @endphp
                ...
                <div class="kt-scrollable-x-auto">
                    <div class="kt-menu gap-3" data-kt-menu="true">
                        <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary here">
                            ...
                            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold">
                                Profil
                            </span>
                            </a>
                        </div>
                        ...
                        <div class="kt-menu-item border-b-2 border-b-transparent">
                            ...
                            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground hover:text-primary">
                                Düzenle
                            </span>
                            </a>
                        </div>
                ...
                <div data-kt-dropdown="true" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
                    ...
                    <div class="kt-dropdown-menu w-full max-w-[220px]" data-kt-dropdown-menu="true">
                        <ul class="kt-dropdown-menu-sub">
                            <li>
                                <a class="kt-dropdown-menu-link" href="{{ route('admin.profile.edit') }}" data-kt-dropdown-dismiss="true">
                                    <i class="ki-filled ki-setting-3"></i>
                                    Ayarlar
                                </a>
                            </li>
                            <li>
                                <button class="kt-dropdown-menu-link" type="button" data-kt-dropdown-dismiss="true" onclick="navigator.clipboard?.writeText(window.location.href)">
                                    <i class="ki-filled ki-share"></i>
                                    Profili Paylaş (Link Kopyala)
                                </button>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
                                <div class="flex flex-col gap-3">
                                    ...
                                    <p class="text-sm text-secondary-foreground leading-5.5">
                                        Şimdilik sadece mevcut alanlarla ilerliyoruz: isim, email, aktiflik ve doğrulama.
                                        Avatar/diğer alanları DB’ye kolon eklemeden gerçek yapamazsın.
                                    </p>
                                </div>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-table kt-scrollable-x-auto">
                            <table class="kt-table table-fixed">
                                ...
                                <tr>
                                    <td class="text-start">
                                        <span class="text-sm font-medium text-mono">Örnek Proje</span>
                                    </td>
                                    <td>
                        ...
                        <div class="kt-card-footer justify-center">
                        <span class="kt-link kt-link-underlined kt-link-dashed text-muted-foreground">
                            Tüm Projeler (sonra bağlarız)
                        </span>
                        </div>
                    </div>
