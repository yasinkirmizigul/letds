...
@section('content')
    ...
    @php
        ...
        // Basit alanlar (null-safe)
        $fullName = trim(($u->name ?? '') . ' ' . ($u->surname ?? '')) ?: ($u->name ?? 'Kullanıcı');
        $company = $u->company ?? '—';
        $location = $u->location ?? '—';
        $email = $u->email ?? '—';

        // Avatar (senin sistemin neyse ona göre)
        $avatarUrl = $u->avatar_url ?? asset('assets/media/avatars/300-1.png');

        // Badge/Verified gibi bir durumun yoksa false bırak
        $isVerified = (bool)($u->email_verified_at ?? false);
    @endphp
    ...
    <div class="kt-container-fixed">
        <div class="flex items-center flex-wrap md:flex-nowrap lg:items-end justify-between border-b border-b-border gap-3 lg:gap-6 mb-5 lg:mb-10">
            ...
            <div class="grid">
                <div class="kt-scrollable-x-auto">
                    <div class="kt-menu gap-3" data-kt-menu="true">
                        {{-- Burayı basit tuttum: admin içinde public-profile dropdown gereksiz.
                             İstersen aynen dropdown’lı hali de çıkarırım. --}}
                        <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-here:border-b-primary here">
                            <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="{{ route('admin.profile.index') }}">
                                <span class="kt-menu-title text-nowrap text-sm text-secondary-foreground kt-menu-item-here:text-primary kt-menu-item-here:font-medium">
                                    Profil
                                </span>
                            </a>
                        </div>

                        <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-here:border-b-primary">
                            <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="{{ route('admin.profile.edit') }}">
                                <span class="kt-menu-title text-nowrap text-sm text-secondary-foreground kt-menu-link-hover:text-primary">
                                    Düzenle
                                </span>
                            </a>
                        </div>
            ...
            <div class="flex items-center justify-end grow lg:grow-0 lg:pb-4 gap-2.5 mb-3 lg:mb-0">
                ...
                <button class="kt-btn kt-btn-icon kt-btn-outline" type="button">
                ...
                <div data-kt-dropdown="true"
                    ...
                    <button class="kt-dropdown-toggle kt-btn kt-btn-icon kt-btn-outline" data-kt-dropdown-toggle="true" type="button">
                    ...
                    <div class="kt-dropdown-menu w-full max-w-[220px]" data-kt-dropdown-menu="true">
                        <ul class="kt-dropdown-menu-sub">
                            ...
                            <li>
                                <a class="kt-dropdown-menu-link" href="#" data-kt-modal-toggle="#share_profile_modal">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-7.5">
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content pt-4 pb-3">
                            <table class="kt-table-auto">
                                ...
                                <tr>
                                    <td class="text-sm text-secondary-foreground pb-3.5 pe-3">Firma</td>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content">
                            <div class="flex flex-wrap gap-2.5 mb-2">
                                <span class="kt-badge kt-badge-outline">Laravel</span>
                                <span class="kt-badge kt-badge-outline">MySQL</span>
                                <span class="kt-badge kt-badge-outline">UI/UX</span>
                                <span class="kt-badge kt-badge-outline">RBAC</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-2">
                <div class="flex flex-col gap-5 lg:gap-7.5">
                            ...
                            <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
                                <div class="flex flex-col gap-3">
                                    ...
                                    <p class="text-sm text-secondary-foreground leading-5.5">
                                        Avatar, şifre, iletişim bilgileri ve diğer ayarlarını tek ekranda yönet.
                                    </p>
                                </div>

                                <img alt="image" class="dark:hidden max-h-[160px]" src="{{ asset('assets/media/illustrations/1.svg') }}"/>
                                <img alt="image" class="light:hidden max-h-[160px]" src="{{ asset('assets/media/illustrations/1-dark.svg') }}"/>
                            </div>
                        </div>

                        <div class="kt-card-footer justify-center">
                            <a class="kt-link kt-link-underlined kt-link-dashed" href="{{ route('admin.profile.edit') }}">
                                Düzenlemeye Git
                            </a>
                        </div>
                    </div>

                    {{-- Placeholder: Chart alanları --}}
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
                        <div class="kt-card">
                            <div class="kt-card-header">
                                <h3 class="kt-card-title">Aktivite</h3>
                            </div>
                            <div class="kt-card-content flex justify-center items-center px-3 py-10 text-secondary-foreground">
                                Chart alanı (sonra bağlarız)
                            </div>
                        </div>
                    ...
                    {{-- Projects Table (örnek) --}}
                    <div class="kt-card">
                        <div class="kt-card-header">
                            <h3 class="kt-card-title">Projeler</h3>
                                    ...
                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="#">
                                                ...
                                                <span class="kt-menu-title">Görüntüle</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="kt-card-table kt-scrollable-x-auto">
                            <table class="kt-table table-fixed">
                                <thead>
                                <tr>
                                    <th class="text-start w-52">Proje</th>
                                    <th class="w-56 text-end">İlerleme</th>
                                    <th class="w-36 text-end">Kişi</th>
                                            ...
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                         src="{{ asset('assets/media/avatars/300-4.png') }}" alt="">
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                         src="{{ asset('assets/media/avatars/300-1.png') }}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </td>
