...
@section('content')
    <div class="px-4 lg:px-6">
        ...
        <div class="kt-card max-w-2xl">
            <form class="kt-card-content flex flex-col gap-5 p-8" method="POST" action="{{ route('admin.users.store') }}">
                @csrf
                ...
                <label class="kt-label">
                    <input class="kt-checkbox kt-checkbox-sm" name="is_active" type="checkbox" value="1" @checked(old('is_active', true)) />
                ...
                <div class="flex flex-col gap-2">
                    ...
                    @error('roles') <div class="text-xs text-danger">{{ $message }}</div> @enderror
                </div>
