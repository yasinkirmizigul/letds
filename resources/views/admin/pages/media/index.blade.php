            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
                <div class="kt-card">
                    <div class="kt-card-content p-5">
                        <div class="text-sm text-muted-foreground">Aktif medya</div>
                        <div class="mt-2 text-2xl font-semibold">{{ number_format((int) ($stats['active'] ?? 0)) }}</div>
                    </div>
                </div>
                <div class="kt-card">
                    <div class="kt-card-content p-5">
                        <div class="text-sm text-muted-foreground">Silinenler</div>
                ...
                <div class="kt-card">
                    <div class="kt-card-content p-5">
                        <div class="text-sm text-muted-foreground">Video</div>
                        <div class="mt-2 text-2xl font-semibold">{{ number_format((int) ($stats['videos'] ?? 0)) }}</div>
                    </div>
                </div>
                <div class="kt-card">
                    <div class="kt-card-content p-5">
                        <div class="text-sm text-muted-foreground">PDF</div>
                        <div class="mt-2 text-2xl font-semibold">{{ number_format((int) ($stats['pdfs'] ?? 0)) }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="kt-card">
                ...
                <div class="kt-card-content p-5">
                    ...
                    <div id="mediaBulkBar" class="hidden kt-card mb-4">
                        <div class="kt-card-content p-3 flex items-center justify-between gap-3 flex-wrap">
                    ...
                    <div id="mediaGrid" class="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-5 gap-4"></div>
