                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span id="blog_publish_badge"
                                              class="kt-badge kt-badge-sm { old('is_published', $blogPost->is_published) ? 'kt-badge-light-success' : 'kt-badge-light text-muted-foreground' }">
                    { old('is_published', $blogPost->is_published) ? 'Yayında' : 'Taslak' }
                </span>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <label class="kt-switch kt-switch-sm">
                                            <input
                                                ...
                                                name="is_featured"
                                                value="1"
                                                @checked(old('is_featured', $blogPost->is_featured))
                                            >
                                        </label>

                                        <span id="blog_featured_badge"
                                              class="kt-badge kt-badge-sm { old('is_featured', $blogPost->is_featured) ? 'kt-badge-light-success' : 'kt-badge-light text-muted-foreground' }">
                                            { old('is_featured', $blogPost->is_featured) ? 'Anasayfada' : 'Kapalı' }
                                        </span>
                                    </div>
                                </div>
                            </div>
